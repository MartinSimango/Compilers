...
public class Parser {
	...
	public const int plusequal_Sym = 40;
	public const int minusequal_Sym = 41;
	public const int starequal_Sym = 42;
	public const int slashequal_Sym = 43;
	...
	static void Statement() {
		if (la.kind == lbrace_Sym) {
			...
			ConstDeclarations();
		} else if (la.kind == int_Sym || la.kind == bool_Sym) {
			VarDeclarations();
			...
			WriteStatement();
		} else if (la.kind == do_Sym) {
			DoWhileStatement();
		} else if (la.kind == break_Sym) {
			Get();
		} else if (la.kind == continue_Sym) {
			Get();
	...
	static void WhilelessStatement() {
		if (la.kind == lbrace_Sym) {
			WhilelessBlock();
		} else if (la.kind == semicolon_Sym) {
			Get();
	...
	static bool[,] set = {
		...
		{x,T,x,x, x,x,x,x, T,x,T,T, T,T,x,x, x,x,x,x, x,T,x,x, T,T,T,x, x,T,T,T, T,x,x,x, x,x,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, T,x,T,T, T,T,x,x, x,x,x,x, x,T,x,x, x,T,T,x, x,T,T,T, T,x,x,x, x,x,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,x, T,x,T,x, x,x,x,x, x,x,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,T,T,T, T,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		...
		{x,x,T,x, T,x,x,x, x,x,x,x, x,x,x,T, T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 23: s = "\"elsif\" expected"; break;
			...
			case 57: s = "invalid DoWhileStatement"; break;
			case 58: s = "invalid ForStatement"; break;
			case 59: s = "invalid ForStatement"; break;
			case 60: s = "invalid WhilelessStatement"; break;
			case 61: s = "invalid AssignOp"; break;
			...
			case 69: s = "invalid BasicType"; break;
